...
(async () => {
  ...
  await page.goto('https://8080-bcbcafcdfbebbedffaceaeddacbcbaadbf.project.examly.io');
  ...
  await page1.goto('https://8081-bcbcafcdfbebbedffaceaeddacbcbaadbf.project.examly.io');
