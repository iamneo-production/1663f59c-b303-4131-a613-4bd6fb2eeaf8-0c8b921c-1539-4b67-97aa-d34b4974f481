...
(async () => {
  ...
  await page.goto('https://8080-edbbcaccedeedffaceaeddacbcbaadbf.project.examly.io');
  ...
  await page1.goto('https://8081-edbbcaccedeedffaceaeddacbcbaadbf.project.examly.io');
