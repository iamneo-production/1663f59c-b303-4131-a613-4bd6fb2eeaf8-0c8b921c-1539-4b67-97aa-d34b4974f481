...
(async () => {
  ...
  await page.goto('https://8080-bacabeafabfedffaceaeddacbcbaadbf.project.examly.io');
  ...
  await page1.goto('https://8081-bacabeafabfedffaceaeddacbcbaadbf.project.examly.io');
